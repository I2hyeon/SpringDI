...
public class JavaConfig {
	...
	/*
	 * <bean id="ds" class="ex02.setter.MyDataSource"> <property name="url"
	 * value="jdbc:orcle:thin:@localhost~" /> <property name="uid" value="jsp" />
	 * <property name="upw" value="jsp" /> </bean>
	 */
	
	@Bean
	public MyDataSource ds() {
		MyDataSource ds = new MyDataSource();
		ds.setUrl("jdbc:orcle:thin:@locahost~");
		ds.setUid("jsp");
		ds.setUpw("jsp");
		return ds;
	}
	...
	/*
	 * <bean id="memberDAO" class="ex02.setter.MemberDAO"> <property
	 * name="myDataSource" ref="ds" /> </bean>
	 */
